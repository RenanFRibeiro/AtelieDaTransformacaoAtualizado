...
public static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        // Em produção (Azure App Service), a conexão deve vir de
        // ConnectionStrings__DefaultConnection ou da seção Connection strings
        // do próprio App Service. Em desenvolvimento, appsettings.Development.json
        // fornece uma conexão LocalDB para o projeto funcionar imediatamente.
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            throw new InvalidOperationException(
                ...
                "No Azure, configure ConnectionStrings__DefaultConnection nas Environment variables " +
                "(ou DefaultConnection em Connection strings). Em desenvolvimento, configure " +
                "ConnectionStrings:DefaultConnection em appsettings.Development.json.");
        }
